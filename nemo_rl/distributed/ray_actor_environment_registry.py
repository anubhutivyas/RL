...
ACTOR_ENVIRONMENT_REGISTRY: dict[str, str] = {
    ...
    "nemo_rl.models.policy.workers.dtensor_policy_worker.DTensorPolicyWorker": PY_EXECUTABLES.VLLM,
    "nemo_rl.models.policy.workers.fsdp1_policy_worker.FSDP1PolicyWorker": PY_EXECUTABLES.BASE,
