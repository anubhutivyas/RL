...
from nemo_rl.algorithms.pass_at_k import pass_at_k_train
...
def main():
    ...
    print("\n🎯 Starting Pass@K Training...")
    print("This algorithm optimizes pass@K by computing advantages as:")
    print("  advantage(response) = pass@k(all responses) - pass@k(all responses except current)")
